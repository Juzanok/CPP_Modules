...
/*   Updated: 2022/11/05 14:01:44 by jkarosas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(Form const & form) const {
	if (this->grade > form.getExecGrade())
		std::cout << this->name << " couldn't execute " << form.getName() << " because their grade is too low" << std::endl;
	else if (!form.getIsSigned())
		std::cout << this->name << " couldn't execute " << form.getName() << " because the form isn't signed" << std::endl;

...
/*   Updated: 2022/11/07 15:30:13 by jkarosas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool Form::check_exec(Bureaucrat const & executor) const{
...
const char* Form::FormIsNotSignedException::what() const throw() {
	return ("Form::FormIsNotSignedException : Form can not be executed, because it is not signed");
}